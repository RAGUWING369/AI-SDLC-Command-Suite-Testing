...
## Rule 0 — Read Both Rule Files First

Every phase agent (01–14) must read **both** `rules/RULE-BEHAVIOR.md` and `rules/RULE-EXECUTION.md` as the **very first action** — before reading CLAUDE.md, phase artifacts, or the codebase. Apply all rules from both files to every execution.

**Reading order:**
1. `rules/RULE-BEHAVIOR.md` ← you are here
2. `rules/RULE-EXECUTION.md` ← read immediately after
