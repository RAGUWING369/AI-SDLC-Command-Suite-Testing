...
### Step 3: Why Now — Market Timing

The PRD must answer: "Why is this the right time to build this product?"

Document the factors that create the current window of opportunity:
- **Technology shift:** What capability has recently become available or affordable? (e.g., LLM APIs, edge compute, new mobile APIs)
- **Regulatory shift:** What new regulation creates demand or removes barriers?
- **Behavior shift:** What user behavior has changed that makes this more valuable now?
- **Competitive window:** What are competitors not doing — and for how long?
- **Internal trigger:** Why is this team positioned to win now?

This section forces clarity on urgency and prevents building things whose time hasn't come.
...
[Why now? From Step 3 — the market timing argument. 1 paragraph maximum]
...
**Content quality:**
- [ ] "Why Now" is answered — market timing is specific and evidence-backed
...
📋 PLEASE REVIEW BEFORE APPROVING:
  ...
  - [ ] "Why Now" market timing argument is specific and evidence-backed
