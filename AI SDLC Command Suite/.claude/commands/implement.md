...
- For frontend tasks: `docs/visuals/ux/SCR-XXX-*.html` wireframe files must be present (agent reads the file specified in the task's `Wireframe Reference` field before writing any component code)
